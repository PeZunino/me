	...
	return (
		<div className={section}>
			<p>
				...
				<Reveal label="NEST / NEXT"> {' '}E foi aí que descobri meu lugar: criando produtos do zero, colaborando com ideias, pensando em{' '}</Reveal>
				<Reveal label="ARQUITETURA">{' '}e boas práticas. Hoje, tenho me aprofundado em conceitos como{' '}</Reveal>

				<Reveal label="TDD / DDD">{' '}conhecendo mais sobre{' '}</Reveal>
				<Reveal label="SDLC / PATTERNS">{' '}explorando formas de construir software com mais intenção, clareza e escala. Ainda tô absorvendo bastante coisa{' '}
					<Reveal dependsOnLabel="SDLC / PATTERNS" label="EM BREVE">, talvez compartilhe por aqui o que ando aprendendo. Moro em </Reveal>
				</Reveal>
				<Reveal label="ITAJAÍ">, Santa Catarina. Você pode me achar no{' '}</Reveal>
				<Reveal label="GITHUB">{' '} ou LinkedIn</Reveal>
			</p>
		</div >
	);
}
