	...
	return (
		<div className={section}>
			...
			<p>
				...
				<Reveal label="WEB">
					e foi aí que tudo começou a fazer ainda mais sentido. Nos últimos anos, fui de soluções low-code como
					<Reveal dependsOnLabel='WEB' label="MENDIX"> até cair de cabeça em stacks como </Reveal>
				</Reveal>
